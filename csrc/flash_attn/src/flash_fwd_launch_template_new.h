...
void run_flash_fwd(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    constexpr bool IsEvenMNConst = true;
    ...
    BOOL_SWITCH(return_softmax, ReturnSoftmaxConst, [&] {
        BOOL_SWITCH(aggregate_key_attn, AggregateKeyAttn, [&] {
            ...
            auto kernel = &flash_fwd_kernel<Kernel_traits, Is_dropout && !Is_softcap, Is_causal, Is_local && !Is_causal, Has_alibi, IsEvenMNConst && IsEvenKConst && !Is_local && !ReturnSoftmaxConst && Kernel_traits::kHeadDim <= 128, IsEvenKConst, Is_softcap, ReturnSoftmaxConst && !Is_softcap, AggregateKeyAttn>;
